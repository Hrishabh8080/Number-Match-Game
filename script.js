...
const setImageSrc = (setImageSrc) => {
    const imageContainer = document.getElementById("imageContainer");
    const image = `<img src = 'images/${setImageSrc}' class='fade'>`;
    imageContainer.innerHTML = image;
}

const setImageName = (imageTitleName) => {
    document.getElementById("item-name").innerHTML = imageTitleName;
}
